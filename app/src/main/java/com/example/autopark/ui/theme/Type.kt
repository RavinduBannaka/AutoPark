...
// Modern font families - will fall back to default if custom fonts not available
val RobotoFontFamily = FontFamily.Default

// Alternatively, if you have custom fonts, add them to res/font folder:
...
val Typography = Typography(
    ...
    // Title styles - Card titles, app bar titles
